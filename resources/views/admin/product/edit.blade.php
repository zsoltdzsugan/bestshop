<x-admin-layout>
    ...
    <div class="overflow-hidden w-full overflow-x-auto rounded-radius border border-outline dark:border-outline-dark p-4">
        <section>
            ...
            <form method="post" action="{{ route('admin.product.update', $product->id) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('patch')
                ...
                <div class="flex gap-8">
                    <div>
                        ...
                        <img class="w-60 max-h-60" name="old-preview" id="old-preview" src="{{ asset('storage/' . $product->image) }}" />
                ...
                <div class="flex w-full gap-4 justify-between max-w-sm">
                    <div class="w-full">
                        ...
                        <x-select-input id="category" name="category" type="text" class="mt-1 block w-full p-2">
                    ...
                    <div class="w-full">
                        ...
                        <x-select-input id="sub-category" name="sub-category" class="mt-1 block w-full">
                        </x-select-input>
