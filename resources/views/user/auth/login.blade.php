            ...
            <div class="py-8 px-4 sm:px-10">
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-6">
                        <div>
                            <a href="#"
                                class="flex justify-center items-center py-3 w-full text-sm font-medium focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:opacity-100 active:outline-offset-0 bg-surface dark:bg-surface-dark-alt/50 border border-outline dark:border-outline-dark hover:border-primary dark:hover:border-primary-dark dark:text-on-primary-dark dark:focus-visible:outline-primary-dark transition ease-in-out duration-150 cursor-pointer group">
