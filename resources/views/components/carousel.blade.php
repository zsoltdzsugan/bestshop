        ...
        <template x-for="(slide, index) in slides">
            <div x-cloak x-show="currentSlideIndex == index + 1" class="absolute inset-0" x-transition.opacity.duration.1000ms>
                ...
                <div class="lg:px-32 lg:py-14 absolute inset-0 z-10 flex flex-col items-start justify-center gap-2 bg-linear-to-t from-surface-dark/85 to-transparent px-16 py-12">
                    <h3 class="w-full lg:w-[90%] text-balance text-3xl font-bold text-on-surface-dark-strong" x-text="slide.title" x-bind:aria-describedby="'slide' + (index + 1) + 'Description'"></h3>
                    <h1 class="lg:w-[90%] w-full text-pretty text-6xl text-on-surface-dark" x-text="slide.description" x-bind:id="'slide' + (index + 1) + 'Description'"></h1>
                    <h4 class="w-full lg:w-[90%] text-balance text-xl font-bold text-on-surface-dark-strong" x-text="slide.subtitle" x-bind:aria-describedby="'slide' + (index + 1) + 'Description'"></h4>
