...
<label for="{{ $name }}" class="cursor-pointer inline-flex min-w-40 items-center justify-between gap-3 rounded-radius bg-surface-alt px-4 py-1.5 dark:bg-surface-dark-alt">
