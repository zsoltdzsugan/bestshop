<article class="group flex p-2 rounded-md shadow-md max-w-sm flex-col overflow-hidden border border-outline bg-surface-alt text-on-surface dark:border-outline-dark dark:bg-surface-dark-alt dark:text-on-surface-dark">
    <!-- Image -->
    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col md:flex-row justify-between mt-4">
            ...
            <div class="flex flex-col gap-1">
                <h3 class="text-sm lg:text-md text-on-surface-strong dark:text-on-surface-dark-strong" aria-describedby="productDescription">CASIO G-SHOCK GA2100</h3>
                <!-- Rating -->
                ...
                <span class="text-lg font-semibold"><span class="sr-only">Price</span>$99.99</span>
            </div>
        </div>
    </div>
</article>
