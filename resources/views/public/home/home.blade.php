<x-public-layout>
    <div class="max-w-7xl mx-auto shadow-sm rounded-md space-y-12">
        ...
        <section id="promo" class="overflow-hidden rounded-md shadow md:grid md:grid-cols-3 max-h-80">
            <img
            alt=""
        ...
        <section id="banners-sale" class="flex w-full h-auto gap-8 rounded-md">
            <!-- Left Image -->
            <div class="relative w-1/2 h-auto min-h-[280px] max-h-[560px] bg-cover bg-center rounded-md"
                ...
                <div class="relative flex flex-col justify-center items-center h-full p-4">
                    <h1 class="text-8xl font-bold text-blue-500">35% Off</h1>
                    <p class="text-5xl text-gray-100 font-bold">Women's clothing</p>
            ...
            <div class="flex flex-col gap-8 w-1/2 rounded-md">
                <!-- Top Image -->
                <div class="relative w-full bg-cover min-h-[248px] rounded-md"
                     style="background-image: url('{{ asset('storage/home/banners/category_sale_2.jpg') }}');">
                    <div class="absolute inset-0 bg-black bg-opacity-60 rounded-md"></div>
                    <div class="relative flex flex-col justify-center items-start h-full px-16">
                        <p class="text-xl text-gray-100 font-bold">New Collection</p>
                        <p class="text-4xl text-gray-100 font-bold">Kid's Fashion</p>
                        <x-primary-button class="mt-6">
                            Shop Now
                        </x-primary-button>
                    </div>
                ...
                <!-- Bottom Image -->
                <div class="relative w-full bg-contain bg-center min-h-[248px] rounded-md"
                     style="background-image: url('{{ asset('storage/home/banners/category_sale_3.jpg') }}');">
                    <div class="absolute inset-0 bg-black bg-opacity-60"></div>
                    <div class="relative flex flex-col justify-center items-start h-full px-16">
                        <h1 class="text-5xl font-bold text-blue-500">20% Off</h1>
                        <p class="text-3xl text-gray-100 font-bold">SmartWatch</p>
                        <x-primary-button class="mt-6">
                            Shop Now
                        </x-primary-button>
                    </div>
        ...
        <section id="marquee" class="space-y-6">
            <div
                x-data
                x-init="
                        $nextTick(() => {
                ...
                <div class="relative w-full py-3 mx-auto overflow-hidden text-lg italic tracking-wide text-white uppercase bg-slate-900 max-w-7xl sm:text-xs md:text-sm lg:text-base xl:text-xl 2xl:text-2xl rounded-md">
                    ...
                    <div x-ref="content" class="flex animate-marquee">
                        <div x-ref="item" class="flex items-center justify-around flex-shrink-0 w-full py-2 space-x-2 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" class="fill-gray-100 size-20">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30" class="fill-gray-100 size-20">
